...
import com.badmintonManager.badmintonManager.DTO.PaymentResDTO;
...
public class PaymentController {
	...
	public ResponseEntity<?> createPayment() throws UnsupportedEncodingException{
        ...
        System.out.println("Secure Hash (calculated): " + vnp_SecureHash);
        ...
        paymentResDTO.setMassage("Successfully");
